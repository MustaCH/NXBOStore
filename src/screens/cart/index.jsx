  ...
  return (
    <div className="lg:pl-28 lg:flex lg:justify-center fixed lg:static bg-zinc-900 lg:bg-zinc-800 w-full h-full z-50">
      <div className="bg-zinc-900 lg:w-6/12 lg:mt-12 rounded-xl">
        ...
        {cart.length === 0 ? (
          <p className="text-center text-xl text-gray-300 py-24">
            Cart is empty
          </p>
        ) : (
        ...
        <div className="fixed bottom-0 w-full lg:relative bg-zinc-800 rounded-tr-2xl rounded-tl-2xl lg:bg-zinc-900 lg:rounded-bl-xl lg:rounded-br-xl">
