  ...
  return (
    <div className="lg:ps-28">
      <div className="mb-24 lg:mb-0 lg:ps-12 flex flex-col gap-12">
        <h1 className="ps-8 lg:ps-0 text-5xl font-bold text-gray-300  pt-12">
          FAQS
        </h1>
        <div className="flex flex-col gap-12 text-gray-300 px-8">
          <details>
            <summary className="text-xl lg:text-2xl text-orange-500">
